        ...
        <form class="layui-form login-bottom">
            <div class="center">
                ...
                <div id="validatePanel" class="item" style="width: 137px;">
                    ...
                    <img id="refreshCaptcha" class="validateImg" onclick="this.src='/api/sys/captcha?d='+Math.random()" src="/api/sys/captcha" >
                </div>
            ...
            <div class="tip">
                ...
                <a href="/api/sysUser/register" class="forget-password">注册账号</a>
            </div>
            <div class="layui-form-item" style="text-align:center; width:100%;height:100%;margin:0px;">
                <button class="login-btn" type="button" id="loginBtn" lay-submit="" lay-filter="login">立即登录</button>
            </div>
        </form>
    </div>
</div>
<div class="footer">
    ©版权所有 2022-2022 小布丁<span class="padding-5">|</span><a target="_blank" href="http://www.miitbeian.gov.cn">湖南科技大学计算机科学与工程学院</a>
</div>
