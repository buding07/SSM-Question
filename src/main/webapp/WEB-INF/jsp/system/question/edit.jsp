    ...
    <form class="layui-form m-3">
      ...
      <div class="d-flex align-items-center mb-3">
        ...
        <div class="input-group">
          <input type="radio" name="questionStatus" ${question.questionStatus == '1' ? 'checked':''} value="1" title="启用"
                 class="form-control form-control-sm"/>
          <input type="radio" name="questionStatus" ${question.questionStatus == '0' ? 'checked':''} value="0" title="停用"
                 class="form-control form-control-sm"/>
        </div>
      </div>
